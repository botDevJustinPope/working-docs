...
Script created by SQL Compare version 15.4.1.27450 from Red Gate Software Ltd at 12/9/2025 10:19:49 AM
...
GO
ALTER TABLE [dbo].[customers] DROP CONSTRAINT [DF_customers_credit_comments]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Altering [dbo].[styles_groups]'
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[styles_groups] ADD
[group_id_string] AS (CONVERT([varchar](81),[group_id],(0))) PERSISTED
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
[order_pricing_includes_tax] [bit] NOT NULL CONSTRAINT [DF_customers_order_pricing_includes_tax_1] DEFAULT ((0)),
[customers_sales_origins_id] [varchar] (20) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[class] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_class] DEFAULT (''),
[inactive] [bit] NOT NULL CONSTRAINT [DF_customers_inactive] DEFAULT ((0)),
[address1] [varchar] (61) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__addre__2F33991F] DEFAULT (''),
[address2] [varchar] (61) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__addre__3027BD58] DEFAULT (''),
[address3] [varchar] (61) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__addre__311BE191] DEFAULT (''),
[zip] [varchar] (11) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__zip__321005CA] DEFAULT (''),
[city] [varchar] (35) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__city__33042A03] DEFAULT (''),
[state] [varchar] (29) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__state__33F84E3C] DEFAULT (''),
[phone1] [varchar] (21) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__phone__34EC7275] DEFAULT (''),
[phone2] [varchar] (21) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__phone__35E096AE] DEFAULT (''),
[phone3] [varchar] (21) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__phone__36D4BAE7] DEFAULT (''),
[hold] [bit] NOT NULL CONSTRAINT [DF__customers__hold__37C8DF20] DEFAULT ((0)),
[payment_term_id] [varchar] (21) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__payme__38BD0359] DEFAULT (''),
[tax_schedule_id] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF__customers__tax_s__39B12792] DEFAULT (''),
[fax] [varchar] (21) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_fax] DEFAULT (''),
[country] [varchar] (61) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_country] DEFAULT (''),
[address_code] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_address_code] DEFAULT (''),
[contact_person] [varchar] (61) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_contact_person] DEFAULT (''),
[bill_to_address] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_bill_to_address] DEFAULT (''),
[ship_to_address] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_ship_to_address] DEFAULT (''),
[statement_name] [varchar] (65) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_statement_name] DEFAULT (''),
[short_name] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_short_name] DEFAULT (''),
[ship_method] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL CONSTRAINT [DF_customers_ship_method] DEFAULT (''),
[accounting_id] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
ALTER TABLE [dbo].[customers] ALTER COLUMN [credit_comments] [varchar] (500) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding constraints to [dbo].[customers]'
GO
ALTER TABLE [dbo].[customers] ADD CONSTRAINT [DF_customers_credit_comments] DEFAULT ('') FOR [credit_comments]
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
...
IF @@ERROR <> 0 SET NOEXEC ON
GO
PRINT N'Adding foreign keys to [dbo].[styles_groups_detail]'
GO
ALTER TABLE [dbo].[styles_groups_detail] ADD CONSTRAINT [FK_styles_groups_detail_customers] FOREIGN KEY ([customer_id]) REFERENCES [dbo].[customers] ([custnmbr])
GO
ALTER TABLE [dbo].[styles_groups_detail] ADD CONSTRAINT [FK_styles_groups_detail_styles_groups] FOREIGN KEY ([group_id]) REFERENCES [dbo].[styles_groups] ([group_id]) ON DELETE CASCADE
GO
IF @@ERROR <> 0 SET NOEXEC ON
GO
COMMIT TRANSACTION
