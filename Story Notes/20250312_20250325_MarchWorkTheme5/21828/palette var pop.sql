				...
				using (
					select * from (
						VALUES
							...
							(''42b647a5-25be-449c-a92f-25c32f9cf193'', ''palette-error-light-1'', ''Error Color Shade 1'', ''The first shade of the error color'', ''SEED'', GETDATE(), ''SEED'', GETDATE()),
							(''953167f8-096f-4d68-9174-b58876432871'', ''palette-error-light-2'', ''Error Color Shade 2'', ''The second shade of the error color'', ''SEED'', GETDATE(), ''SEED'', GETDATE()),
							(''9141be46-f533-4285-adc8-e2f931e69b91'', ''palette-error-light-3'', ''Error Color Shade 3'', ''The third shade of the error color'', ''SEED'', GETDATE(), ''SEED'', GETDATE()),
